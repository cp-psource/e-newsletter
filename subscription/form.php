        ...
        <form action="" method="post">
            ...
            <div class="psource-tabs" id="tabs">
                <div class="psource-tabs-nav">
                    <button class="psource-tab active" data-tab="tabs-fields"><?php esc_html_e('Main fields', 'newsletter') ?></button>
                    <button class="psource-tab" data-tab="tabs-lists"><?php esc_html_e('Lists', 'newsletter') ?></button>
                    <button class="psource-tab" data-tab="tabs-customfields"><?php esc_html_e('Custom fields', 'newsletter') ?></button>
                ...
                <div class="psource-tabs-content">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($language && !empty($controls->data['privacy_use_wp_url'])) { ?>
                                        <?php esc_html_e('The "all language" setting is set to use the ClassicPress default privacy page. Please translate that page.', 'newsletter') ?>
                                    <?php } else { ?>
                                        <?php if (!$language) { ?>
                                            <?php if (function_exists('get_privacy_policy_url') && get_privacy_policy_url()) { ?>
                                                <?php $controls->checkbox('privacy_use_wp_url', __('Use ClassicPress privacy URL', 'newsletter')); ?>
                                                (<a href="<?php echo esc_attr(get_privacy_policy_url()) ?>"><?php echo esc_html(get_privacy_policy_url()) ?></a>)
                                                <br>OR<br>
                                            <?php } ?>
                                        <?php } ?>
                                        <?php if ($language) { ?>
                                            <?php esc_html_e('To use the ClassicPress privacy page, switch to "all language" and activate it.', 'newsletter') ?><br>
                                        <?php } ?>
                    ...
                    <div class="psource-tab-panel" id="tabs-customfields">
