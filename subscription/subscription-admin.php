...
class NewsletterSubscriptionAdmin extends NewsletterModuleAdmin {
    ...
    function hook_admin_init() {
        if (function_exists('register_block_type')) {
            ...
            wp_register_script('tnp-blocks', plugins_url('e-newsletter') . '/includes/tnp-blocks.js', array('wp-block-editor', 'wp-blocks', 'wp-element', 'wp-components'), NEWSLETTER_VERSION);
...
//        $this->add_menu_page('lists', __('Lists', 'newsletter'));
        ...
        $this->add_admin_page('confirmation', 'Confirmation');
