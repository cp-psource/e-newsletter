...
<script src="<?php echo plugins_url('e-newsletter') ?>/vendor/tinymce/tinymce.min.js"></script>
<script type="text/javascript">
    ...
    tinymce.init({
        ...
        content_css: ["<?php echo plugins_url('e-newsletter') ?>/emails/editor.css", "<?php echo home_url('/') . '?na=emails-css&id=' . $email_id . '&' . time(); ?>"]
    });
