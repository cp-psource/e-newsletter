...
global $post; // Current post managed by ClassicPress
...
// This array will be passed to ClassicPress to extract the posts
$filters = array();
...
// Retrieve the posts asking them to ClassicPress
