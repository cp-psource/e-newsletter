...
//            }
    ...
    function wp_editor($name, $settings = [], $attrs = []) {
        ...
        wp_editor($value, $name, array_merge(
                        [
                            'tinymce' => [
                                'content_css' => plugins_url('e-newsletter') . '/admin/css/wp-editor.css?ver=' . NEWSLETTER_VERSION,
    ...
    function media($name) {
        ...
        if ($media === false) {
            ...
            $media_full = array('', '', '');
            $media_id = 0;
            echo '<img style="max-width: 200px; max-height: 150px; width: 100px;" id="' . esc_attr($name) . '_img" src="' . esc_attr(plugins_url('e-newsletter')) . '/admin/images/nomedia.png" onclick="newsletter_media(\'' . esc_attr($name) . '\')">';
        } else {
    ...
    function composer_load_v2($show_subject = false, $show_test = true, $context_type = '') {
        ...
        echo "<link href='", esc_attr(plugins_url('e-newsletter')), "/emails/tnp-composer/_css/newsletter-builder-v2.css?ver=", rawurlencode(NEWSLETTER_VERSION), "' rel='stylesheet' type='text/css'>";
    ...
    function composer_v3($show_subject = false, $show_test = true, $context_type = '') {
        ...
        // phpcs:ignore WordPress.WP.EnqueuedResources.NonEnqueuedStylesheet
        echo "<link href='", esc_attr(plugins_url('e-newsletter')), "/composer/css/composer.css?ver=", rawurlencode(NEWSLETTER_VERSION), "' rel='stylesheet' type='text/css'>";
