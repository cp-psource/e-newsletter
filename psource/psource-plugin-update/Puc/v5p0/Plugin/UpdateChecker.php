...
use Psource\PluginUpdateChecker\v5p0\InstalledPackage;
use Psource\PluginUpdateChecker\v5p0\UpdateChecker as BaseUpdateChecker;
use Psource\PluginUpdateChecker\v5p0\Scheduler;
use Psource\PluginUpdateChecker\v5p0\DebugBar;
...
if ( !class_exists(UpdateChecker::class, false) ):
	...
	class UpdateChecker extends BaseUpdateChecker {
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			//Details: https://github.com/Psource/plugin-update-checker/issues/138#issuecomment-335590964
