...
namespace Psource\PluginUpdateChecker\v5p0\Vcs;

use Psource\PluginUpdateChecker\v5p0\Plugin;
	...
	class PluginUpdateChecker extends Plugin\UpdateChecker implements BaseChecker {
		...
		public function requestInfo($unusedParameter = null) {
			...
			if ( empty($info->sections['changelog']) ) {
				...
				if ( empty($info->sections['changelog']) ) {
					$info->sections['changelog'] = __('Ein Änderungsprotokoll ist nicht verfügbar.', 'email-newsletter');
				}
			}
