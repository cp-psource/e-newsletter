...
class NewsletterComposerAdmin extends NewsletterModuleAdmin {
    ...
    function get_all_preset() {
        ...
        if ($user_preset_list) {
            ...
            foreach ($user_preset_list as $user_preset) {
                ...
                $default_icon_url = plugins_url('e-newsletter') . "/emails/presets/default-icon.png?ver=2";
    ...
    private function get_raw_html_preset_element() {
        ...
        $result .= "<img src='" . plugins_url('e-newsletter') . "/emails/images/rawhtml.png' title='RAW HTML' alt='RAW'/>";
