...
//    static $old_default_templates = ['announcement', 'cta', 'invite', 'posts', 'product', 'simple', 'tour'];
    ...
    function build_block($dir) {
        ...
        $defaults = ['section' => 'content', 'name' => ucfirst($file), 'descritpion' => '', 'icon' => plugins_url('e-newsletter') . '/admin/images/block-icon.png'];
...
//            $json = str_replace("{placeholder_base_url}", plugins_url('e-newsletter') . '/emails/presets', $json);
//            $data = json_decode($json);
//            if (!$data) {
//                continue;
//            }
