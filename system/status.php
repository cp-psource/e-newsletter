                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (defined('WP_DEBUG') && WP_DEBUG) { ?>
                                        ClassicPress is in debug mode it is not recommended on a public site. See the constant <code>WP_DEBUG</code> inside the <code>wp-config.php</code>.
                                    <?php } else { ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        Your PHP execution time limit is <?php echo $value ?> seconds and can be changed by PS eNewsletter.<br>
                                    <?php } ?>
